...
//     img.src = '/assets/images/hero/hero.png' // Replace with your image path
//     img.onload = function () {
//       init()
//       glitchAnimation()
//     }
...
//       d[i] = 0 // Set red channel to 0
//       d[i + 1] = 222 // Set green channel to 222
//       d[i + 2] = 212 // Set blue channel to 212 (teal color)
//       d[i + 3] = randInt(1, 3) + 8 // Adjust the alpha channel
//     }
...
//     //   d[i] = 1
//     //   d[i + 1] += randInt(2, 5)
//     //   d[i + 2] = 0 // Set blue channel to 0 for teal color
//     //   d[i + 3] = randInt(1, 3) + 8 // Adjust the alpha channel
//     // }
...
//   return (
//     <div className={`${styles.glitchImageContainer} opacity-40`}>
//       <canvas
//         id='canvas'
//         ref={canvasRef}
...
//       <img
//         ref={imgRef}
//         className={`${styles.glitchImage} opacity-0 hidden`}
//         alt='Glitched'
//       />
//     </div>
//   )
